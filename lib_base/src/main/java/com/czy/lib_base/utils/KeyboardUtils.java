...
public final class KeyboardUtils {
     ...
     */
    public static void hideSoftInput(Context context, @NonNull final Window window) {
    ...
    private static int getDecorViewInvisibleHeight(@NonNull final Window window) {
        ...
        if (delta <= BarUtils.getNavBarHeight(window.getContext()) + BarUtils.getStatusBarHeight(window.getContext())) {
